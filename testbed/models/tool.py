...
def get_cmd(job_name, allocation, rank, acc_bsz, acc_step, model_name=None, master_port=None):
    ...
    master_port = get_port(job_name) if master_port is None else master_port
