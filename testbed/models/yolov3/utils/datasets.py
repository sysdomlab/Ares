...
import models.yolov3.config.yolov3_config_voc as cfg
import cv2
import numpy as np
import random
...
import models.yolov3.utils.data_augment as dataAug
import models.yolov3.utils.tools as tools


class VocDataset(Dataset):
    def __init__(self, anno_file_type, img_size=416, data_path=None):
    ...
    def _load_annotations(self, anno_type):
        ...
        # print(f"show annotations from {anno_path}")
    ...
    def _parse_annotation(self, annotation):
        ...
        img_path = anno[0]
        if self.data_path is not None:  # data_path = "/home/cchen/yfliu/ares/data/voc"
            if "/mnt/VOC/VOCtrainval-2007/VOCdevkit/VOC2007" in img_path:
                img_path = img_path.replace("/mnt/VOC/VOCtrainval-2007/VOCdevkit", self.data_path)
            if "/mnt/VOC/VOCtrainval-2012/VOCdevkit/VOC2012" in img_path:
                img_path = img_path.replace("/mnt/VOC/VOCtrainval-2012/VOCdevkit", self.data_path)
            if "/mnt/VOC/VOCtest-2007/VOCdevkit/VOC2007" in img_path:
                img_path = img_path.replace("/mnt/VOC/VOCtest-2007/VOCdevkit", self.data_path)
        # print(f"show image from {img_path}")
