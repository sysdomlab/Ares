...
def load_all(test_num=100, data_path=None):
    if data_path is not None:
        config.train_rating = config.train_rating.replace('/mnt/ncf/data', data_path)
        config.test_rating = config.test_rating.replace('/mnt/ncf/data', data_path)
        config.test_negative = config.test_negative.replace('/mnt/ncf/data', data_path)
