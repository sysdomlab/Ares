...
class Application(object):
    def __init__(self, trace_dir,
                 ...
                 slowdown_factor=1., rescale_time=0):
    ...
    def get_throughput(self, placement, local_bsz):
        ...
        if (placement_id in self.placements.placement.values
            ...
            try:
                ...
                df = df._append(self.scalability[xs + ys], ignore_index=True)
        ...
        return step_time * self.slowdown_factor, sync_time * self.slowdown_factor
